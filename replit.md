...
- **Connections System**: Tenant-specific bot configuration for Signal Bot and User Account (Telethon), storing bot tokens, channel IDs, webhook secrets, and `free_channel_link` (public fallback). This is the single source of truth for bot credentials. Message Bot is removed from the UI. Connections page uses iOS-style single-column expandable accordion layout.
