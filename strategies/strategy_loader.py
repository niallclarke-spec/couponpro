...
def get_active_strategy(bot_type: str = 'aggressive') -> Optional[BaseStrategy]:
    """
    ...
    if 'aggressive' in STRATEGY_REGISTRY:
        ...
        return STRATEGY_REGISTRY['aggressive']()
    
    return None


def get_strategy_by_type(bot_type: str) -> Optional[BaseStrategy]:
    """Get a specific strategy by its bot_type"""
    return get_active_strategy(bot_type)
